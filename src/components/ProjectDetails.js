...
import ProjecForm from './ProjecForm';
...
const handleOverlay=()=>{
 ...
 setIsOverlayOpen(false)
  ...
  <div className='top'>
         ...
         < span className="uppercase text-xs -tracking-widest text-500 font-medium">{project.tech}</span>
  ...
  <div className='bottom flex gap-5'>
    <button onClick={handleUpdate} className='bg-sky-400 text-slate-900 py-2 px-5 rounded shadow-xl hover:bg-sky-50 duration:300'>Update </button>
...
{
  <div onClick={handleOverlay } className={`overlay fixed z-[1] h-screen w-screen  bg-slate-900/50 backdrop-blur-sm top-0 left-0 right-0 bottom-0 ${isOverlayOpen ? "":"hidden"} `}>
...
< h2 className='text-4xl font-medium text-sky-400 mb-10'> Update  Projects</h2>
<ProjecForm project={project} setIsModalOpen={setIsModalOpen}
