...
e.preventDefault();
 ...
 <div className="form control flex flex-col gap-3 ">
    <label htmlFor="email" className='cursor-pointer hover:text-sky-400 duration-300 bg-transparent'>Email address</label>
    <input type="email" id ="email"  placeholder='hello@mail.com' value={email} 
 ...
 <div className="form control flex flex-col gap-3 ">
    <label htmlFor="password" className='cursor-pointer hover:text-sky-400 duration-300'>Password</label>
...
<button disabled={loading} type="submit" className='bg-sky-400   text-slate-900 py-3 mt-3 rounded-xl focus:bg-sky-600 duration-300'>Log in</button>
